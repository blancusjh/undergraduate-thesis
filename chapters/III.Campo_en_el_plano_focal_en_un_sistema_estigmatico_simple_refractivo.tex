...
\begin{figure}[H]
  ...
  \caption{Simulación numérica para incidencia de polarización lineal $\hat{\mathbf y}$ pura $(\mathscr{E}_x,\mathscr{E}_y)=(0,1)$. El resultado es simétrico al caso $(1,0)$: $E_y'$ genera el disco de Airy dominante y $E_x'$ presenta el patrón de cuatro lóbulos de la mezcla por $\mathbb{W}(\varphi)$.}
  \label{fig:cart_01}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption{Simulación numérica para incidencia en superposición equitativa $(\mathscr{E}_x,\mathscr{E}_y)=(1,1)$. En el plano focal ambas componentes presentan discos de Airy de amplitud similar; las contribuciones de mezcla de $\mathbb{W}(\varphi)$ se compensan azimutalmente.}
  \label{fig:cart_11}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption{Simulación numérica para incidencia con desfase $(\mathscr{E}_x,\mathscr{E}_y)=(1,i)$ (polarización circular en la base cartesiana). Las distribuciones de intensidad en el plano focal son análogas al caso $(1,1)$; la diferencia de fase no altera los módulos de las componentes.}
  \label{fig:cart_1i}
\end{figure}
