...
introducida por $t_-$. Comparaciones numéricas realizadas durante el
desarrollo del código —descrito en el apéndice~\ref{apx:numerical_algorithm}—
muestran que las firmas discutidas
—supresión del pico central, deformación anisótropa, componente cruzada
de orden dos— son estables al reemplazar el propagador de Fresnel por el
del espectro angular.
