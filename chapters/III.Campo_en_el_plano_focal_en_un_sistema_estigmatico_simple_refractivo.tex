...
Para obtener resultados en forma cerrada, especializamos el campo incidente a una pupila circular uniforme y aproximamos los coeficientes de Fresnel por su expansi\'on paraxial. Para esta \'ultima, conectamos con las series del ap\'endice~\ref{apx:ovoids_series} (v\'eanse \eqref{eq:fresnel_ts_series_fourth_order}, \eqref{eq:fresnel_tp_series_fourth_order} y \eqref{eq:xi_definition_fresnel_series}). Definimos
