...
\begin{figure}[H]
  ...
  \thesisincludegraphics[width=0.41\textwidth]
    {to_insert/circular/circular_incidente_mapa_polarizacion.pdf}
...
\begin{figure}[H]
  ...
  \thesisincludegraphics[width=0.55\textwidth]
    {to_insert/circular/circular_plano_focal_mapa_polarizacion.pdf}
...
\begin{figure}[H]
  ...
  \thesisincludegraphics[width=0.42\textwidth]
    {to_insert/analisis_polarizacion/circular_plano_focal_elipticidad.pdf}
    {figures/fast/circular_plano_focal_elipticidad.jpg}\hfill
  \thesisincludegraphics[width=0.42\textwidth]
    {to_insert/analisis_polarizacion/circular_plano_focal_angulo_eje_mayor.pdf}
...
\begin{figure}[H]
  ...
  \thesisincludegraphics[width=\textwidth]
    {to_insert/circular/circular_plano_focal_componentes.pdf}
...
\begin{figure}[H]
  \centering
  \thesisincludegraphics[width=0.41\textwidth]
    {to_insert/cilindrico/radial_incidente_mapa_polarizacion_polar_hot_v1.pdf}
    {figures/fast/radial_incidente_mapa_polarizacion_polar_hot_v1.jpg}
...
\begin{figure}[H]
  \centering
  \thesisincludegraphics[width=0.55\textwidth]
    {to_insert/cilindrico/radial_salida_mapa_polarizacion_polar_hot_v1.pdf}
    {figures/fast/radial_salida_mapa_polarizacion_polar_hot_v1.jpg}
...
\begin{figure}[H]
  \centering
  \thesisincludegraphics[width=\textwidth]
    {to_insert/cilindrico/radial_salida_componentes_hot_v1.pdf}
    {figures/fast/radial_salida_componentes_hot_v1.jpg}
...
\begin{figure}[H]
  \centering
  \thesisincludegraphics[width=0.41\textwidth]
    {to_insert/cilindrico/azimutal_incidente_mapa_polarizacion_polar_hot_v1.pdf}
    {figures/fast/azimutal_incidente_mapa_polarizacion_polar_hot_v1.jpg}
...
\begin{figure}[H]
  \centering
  \thesisincludegraphics[width=0.55\textwidth]
    {to_insert/cilindrico/azimutal_salida_mapa_polarizacion_polar_hot_v1.pdf}
    {figures/fast/azimutal_salida_mapa_polarizacion_polar_hot_v1.jpg}
...
\begin{figure}[H]
  \centering
  \thesisincludegraphics[width=\textwidth]
    {to_insert/cilindrico/azimutal_salida_componentes_hot_v1.pdf}
    {figures/fast/azimutal_salida_componentes_hot_v1.jpg}
...
\begin{figure}[H]
  \centering
  \thesisincludegraphics[width=0.41\textwidth]
    {to_insert/lineal/lineal_incidente_mapa_polarizacion.pdf}
...
\begin{figure}[H]
  \centering
  \thesisincludegraphics[width=0.55\textwidth]
    {to_insert/lineal/lineal_plano_focal_mapa_polarizacion.pdf}
...
\begin{figure}[H]
  \centering
  \thesisincludegraphics[width=0.42\textwidth]
    {to_insert/analisis_polarizacion/lineal_plano_focal_elipticidad.pdf}
    {figures/fast/lineal_plano_focal_elipticidad.jpg}\hfill
  \thesisincludegraphics[width=0.42\textwidth]
    {to_insert/analisis_polarizacion/lineal_plano_focal_angulo_eje_mayor.pdf}
...
\begin{figure}[H]
  \centering
  \thesisincludegraphics[width=\textwidth]
    {to_insert/lineal/lineal_plano_focal_componentes.pdf}
