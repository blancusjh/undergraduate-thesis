...
Que la luz tuviese cierta velocidad y no una infinita, como muchos llegarón a creer, fue un importante cambio de paradigma que ayudo a entender mejor la naturaleza de la luz, el hecho de la finitud de la velocidad de la luz fue demostrado a partir de las observaciones de los eclipses de Júpiter \cite{Romer1676} y de numerosos experimentos posteriores por otros cientificos como Fizeau \cite{Fizeau1849}. Hecho que ayudo en gran manera a entender el fenomeno de la refracción.
...
Las investigaciones de P. Fermat dieron como resultado un principio natural por el cual se deducían las ya conocidas leyes de reflexión y refracción, como la propagación rectilínea de la luz, reduciendo la óptica geometrica a este único principio, 
