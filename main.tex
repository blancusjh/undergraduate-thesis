...
% Con \spanishplainpercent el \% vuelve a ser el signo simple y el espaciado
% queda controlado por el \, del texto fuente.
\spanishplainpercent
\usepackage{csquotes}
...
\usepackage{graphicx}
\usepackage{tikz}
% La librería babel desactiva los shorthands de babel-spanish (< > ") dentro de
% los entornos tikzpicture, donde rompen la sintaxis de flechas (->, >=stealth)
% y de la librería quotes ("$\alpha$").
