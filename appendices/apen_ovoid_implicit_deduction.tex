...
Este apéndice deduce, a partir de la condición estigmática de Fermat
\cite{fermat1891oeuvres}, la ecuación polinómica implícita que caracteriza a
la superficie cartesiana \cite{dioptrique}. La forma canónica y su expansión
en series se recogen en el apéndice~\ref{apx:ovoids_series}.

\medskip

Sean $A=(0,0,z_0)$ el punto objeto y $A'=(0,0,z_i)$ el punto imagen sobre el
eje óptico, con coordenadas axiales con signo y el vértice de la superficie
en el origen (en la configuración de conjugados reales, $z_0<0<z_i$), y sea
...
valor se determina evaluando en el vértice $I=(0,0,0)$, donde
$\overline{AI}=|z_0|$ y $\overline{IA'}=|z_i|$. La convención de signos queda
fijada por la propia condición estigmática: para la configuración de
conjugados reales ($z_0<0<z_i$),
\begin{equation}
...
\end{equation}
Sustituyendo $k^2=(n_iz_i-n_0z_0)^2=n_0^2z_0^2+n_i^2z_i^2-2n_0n_iz_0z_i$ y
...
en las coordenadas $(\rho,z)$ del punto $I\in\Sigma$, válida para
coordenadas axiales con signo. Su forma canónica, obtenida dividiendo por un
factor apropiado en $n_0,n_i,z_0,z_i$, es una cuadrática en $z$ con
