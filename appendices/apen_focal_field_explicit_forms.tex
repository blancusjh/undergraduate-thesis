...
El término transformado por $\mathscr{H}_0$ es diagonal y no mezcla las helicidades: puede identificarse con el correspondiente a la teoría escalar de la difracción \cite{goodman2005}, salvo por la modulación por $t_+$; si esta se toma constante, se obtiene exactamente el resultado escalar. Los términos que $\mathscr{H}_2$ transforma acoplan $\ket{L}\leftrightarrow\ket{R}$ con fase azimutal $e^{\mp 2i\varphi}$ y, dado que $J_2(0)=0$, su contribución es estrictamente fuera de eje, por lo que dicha contribución ensancha el tamaño de la mancha focal de manera general y da lugar a un cambio en la polarización.
...
-
\frac{3n_0^2(z_0-z_i)^2}{z_0^2z_i^2(n_0-n_i)(n_0+n_i)}\frac{1}{q^4}
\right)\mathcal I(x)
\\
&\qquad
+
...
+
\frac{3n_0^2(z_0-z_i)^2}{z_0^2z_i^2(n_0-n_i)(n_0+n_i)}\frac{x}{q^4}
\right)J_0(x)
+
\left(
\frac{n_0^2(z_0-z_i)^2}{z_0^2z_i^2(n_0-n_i)(n_0+n_i)}\frac{x^2}{q^4}
\right)J_1(x)
\\
&\qquad
+
\left(
\frac{n_0^2(z_0-z_i)^2}{z_0^2z_i^2(n_0-n_i)(n_0+n_i)}\frac{x^3}{q^4}
\right)J_2(x)
\Bigg],
\\[0.6em]
E'_\phi
...
\frac{2n_0}{n_0+n_i}\frac{1}{q^2}
-
\frac{3n_0n_i(z_0-z_i)^2}{z_0^2z_i^2(n_0-n_i)(n_0+n_i)}\frac{1}{q^4}
\right)\mathcal I(x)
\\
&\qquad
+
...
-\frac{2n_0}{n_0+n_i}\frac{x}{q^2}
+
\frac{3n_0n_i(z_0-z_i)^2}{z_0^2z_i^2(n_0-n_i)(n_0+n_i)}\frac{x}{q^4}
\right)J_0(x)
+
\left(
\frac{n_0n_i(z_0-z_i)^2}{z_0^2z_i^2(n_0-n_i)(n_0+n_i)}\frac{x^2}{q^4}
\right)J_1(x)
\\
&\qquad
+
\left(
\frac{n_0n_i(z_0-z_i)^2}{z_0^2z_i^2(n_0-n_i)(n_0+n_i)}\frac{x^3}{q^4}
\right)J_2(x)
\Bigg].
\end{aligned}
...
\mathscr E_{\perp,0}
=
\mathscr E_{x,0}\,\uvec{x}
+
\mathscr E_{y,0}\,\uvec{y}.
...
Para una polarización incidente lineal en $\uvec{x}$,
\begin{equation}
\mathscr E_{\perp,0}
=
\begin{pmatrix}
...
Para una polarización incidente lineal en $\uvec{y}$,
\begin{equation}
\mathscr E_{\perp,0}
=
\begin{pmatrix}
