...
De esta manera, en los problemas con simétria axial, la solución se reduce a una integral en vez de dos. Ya que 
para el caso general se necesitaba integrar para obtener cada modo angular, a cada uno aplicarle la transformada 
de Hankel segun el orden que corresponda y sumar todos los modos. En el caso simetrico, solo se requiere hacer una 
